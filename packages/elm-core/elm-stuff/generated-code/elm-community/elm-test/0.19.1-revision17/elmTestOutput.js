...
var $author$project$SpecTest$specJson = '\n    {\n      "root": "card-1",\n      "elements": {\n        "card-1": {\n          "type": "Card",\n          "props": { "title": "Hello" },\n          "children": ["btn-1"]\n        },\n        "btn-1": {\n          "type": "Button",\n          "props": { "label": "Click" },\n          "children": []\n        }\n      }\n    }\n    ';
var $author$project$ResolveTest$state = $elm$json$Json$Encode$object(
	_List_fromArray(
		[
			_Utils_Tuple2(
			'user',
			$elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'name',
						$elm$json$Json$Encode$string('Alice')),
						_Utils_Tuple2(
						'age',
						$elm$json$Json$Encode$int(30))
					])))
		]));
var $elm$json$Json$Encode$bool = _Json_wrap;
var $author$project$VisibilityTest$state = $elm$json$Json$Encode$object(
	_List_fromArray(
		[
			_Utils_Tuple2(
			'isAdmin',
...
var $author$project$JsonRender$Actions$PushState = F2(
	function (a, b) {
		return {$: 'PushState', a: a, b: b};
	});
var $author$project$JsonRender$Actions$RemoveState = function (a) {
	return {$: 'RemoveState', a: a};
};
var $author$project$JsonRender$Actions$SetState = F2(
	function (a, b) {
...
var $author$project$JsonRender$Actions$encodeAction = F2(
...
var $author$project$JsonRender$State$getBySegments = F2(
		...
		while (true) {
			if (!segments.b) {
				...
				var indexResult = function () {
					var _v3 = $elm$core$String$toInt(segment);
					if (_v3.$ === 'Just') {
						var idx = _v3.a;
						return A2(
							$elm$json$Json$Decode$decodeValue,
							A2($elm$json$Json$Decode$index, idx, $elm$json$Json$Decode$value),
							value);
					} else {
						return $elm$core$Result$Err(
							A2($elm$json$Json$Decode$Failure, 'not an index', value));
					}
				}();
				var fieldResult = A2(
					$elm$json$Json$Decode$decodeValue,
					A2($elm$json$Json$Decode$field, segment, $elm$json$Json$Decode$value),
					value);
				if (fieldResult.$ === 'Ok') {
					var child = fieldResult.a;
					var $temp$segments = rest,
						$temp$value = child;
					segments = $temp$segments;
					value = $temp$value;
					continue getBySegments;
				} else {
					if (indexResult.$ === 'Ok') {
						var child = indexResult.a;
						var $temp$segments = rest,
							$temp$value = child;
						segments = $temp$segments;
						value = $temp$value;
...
var $author$project$JsonRender$State$parsePath = function (path) {
	return (path === '') ? _List_Nil : A2(
		$elm$core$String$split,
		'/',
		A2($elm$core$String$dropLeft, 1, path));
};
var $author$project$JsonRender$State$get = F2(
	function (path, value) {
		var segments = $author$project$JsonRender$State$parsePath(path);
		return A2($author$project$JsonRender$State$getBySegments, segments, value);
	});
...
var $author$project$JsonRender$State$setField = F3(
		...
		if (_v0.$ === 'Ok') {
			...
			var updated = A2(
				...
				function (_v2) {
					var k = _v2.a;
					var v = _v2.b;
					return _Utils_eq(k, key) ? _Utils_Tuple2(k, value) : _Utils_Tuple2(k, v);
				},
				pairs) : _Utils_ap(
				pairs,
				_List_fromArray(
			...
			return $elm$json$Json$Encode$object(updated);
		} else {
			var _v3 = $elm$core$String$toInt(key);
			if (_v3.$ === 'Just') {
				var idx = _v3.a;
				var _v4 = A2(
					$elm$json$Json$Decode$decodeValue,
				...
				if (_v4.$ === 'Ok') {
					...
					return A2(
						...
						A2(
							...
							F2(
								function (i, v) {
									return _Utils_eq(i, idx) ? value : v;
								}),
							items));
				} else {
					return obj;
...
var $author$project$JsonRender$State$setBySegments = F3(
	function (segments, newValue, state) {
		if (!segments.b) {
			return newValue;
		} else {
			if (!segments.b.b) {
				var segment = segments.a;
				return A3($author$project$JsonRender$State$setField, segment, newValue, state);
			} else {
				var segment = segments.a;
				var rest = segments.b;
				var child = A2(
					...
					A2($author$project$JsonRender$State$get, '/' + segment, state));
				var updatedChild = A3($author$project$JsonRender$State$setBySegments, rest, newValue, child);
				return A3($author$project$JsonRender$State$setField, segment, updatedChild, state);
			}
		}
	});
var $author$project$JsonRender$State$set = F3(
	function (path, newValue, state) {
		var segments = $author$project$JsonRender$State$parsePath(path);
		return A3($author$project$JsonRender$State$setBySegments, segments, newValue, state);
	});
var $author$project$JsonRender$State$push = F3(
	function (path, newValue, state) {
		var _v0 = A2($author$project$JsonRender$State$get, path, state);
		if (_v0.$ === 'Just') {
			var arrayValue = _v0.a;
			var _v1 = A2(
				$elm$json$Json$Decode$decodeValue,
				$elm$json$Json$Decode$list($elm$json$Json$Decode$value),
				arrayValue);
			if (_v1.$ === 'Ok') {
				var items = _v1.a;
				return A3(
					$author$project$JsonRender$State$set,
					path,
					A2(
						$elm$json$Json$Encode$list,
						$elm$core$Basics$identity,
...
var $author$project$JsonRender$State$removeField = F2(
	function (key, obj) {
		var _v0 = A2(
			$elm$json$Json$Decode$decodeValue,
			$elm$json$Json$Decode$keyValuePairs($elm$json$Json$Decode$value),
...
var $author$project$JsonRender$State$remove = F2(
	function (path, state) {
		var segments = $author$project$JsonRender$State$parsePath(path);
		if (!segments.b) {
			return $elm$json$Json$Encode$null;
		} else {
			var parentPath = $elm$core$List$reverse(
				A2(
					$elm$core$List$drop,
					1,
			...
			var lastSegment = A2(
				...
				$elm$core$List$head(
					$elm$core$List$reverse(segments)));
			var parentPointer = $elm$core$List$isEmpty(parentPath) ? '' : ('/' + A2($elm$core$String$join, '/', parentPath));
			var _v1 = A2($author$project$JsonRender$State$get, parentPointer, state);
			if (_v1.$ === 'Just') {
				var parentValue = _v1.a;
				var updatedParent = A2($author$project$JsonRender$State$removeField, lastSegment, parentValue);
				return $elm$core$List$isEmpty(parentPath) ? updatedParent : A3($author$project$JsonRender$State$set, parentPointer, updatedParent, state);
			} else {
				return state;
			}
		}
	});
var $author$project$JsonRender$Actions$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'SpecReceived':
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			case 'SetState':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							state: A3($author$project$JsonRender$State$set, path, value, model.state)
						}),
			...
			case 'PushState':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							state: A3($author$project$JsonRender$State$push, path, value, model.state)
						}),
					$elm$core$Platform$Cmd$none);
			case 'RemoveState':
				var path = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							state: A2($author$project$JsonRender$State$remove, path, model.state)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
...
var $author$project$ActionsTest$suite = A2(
	...
	_List_fromArray(
		[
			...
			function (_v0) {
				var model = {
					spec: $elm$core$Maybe$Nothing,
					state: $elm$json$Json$Encode$object(
						_List_fromArray(
							[
								_Utils_Tuple2(
								'name',
				...
				var _v1 = A2(
					$author$project$JsonRender$Actions$update,
					A2(
						$author$project$JsonRender$Actions$SetState,
						'/name',
						$elm$json$Json$Encode$string('Bob')),
					model);
				var newModel = _v1.a;
				return A2(
					...
					A2(
						...
						A2($author$project$JsonRender$State$get, '/name', newModel.state)));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'PushState appends to array',
			function (_v2) {
				var model = {
					spec: $elm$core$Maybe$Nothing,
					state: $elm$json$Json$Encode$object(
				...
				var _v3 = A2(
					$author$project$JsonRender$Actions$update,
					A2(
						$author$project$JsonRender$Actions$PushState,
						'/items',
				...
				return A2(
					...
					A2(
						...
						A2(
							...
							$elm$json$Json$Decode$decodeValue($elm$json$Json$Decode$string),
							$elm$core$Result$toMaybe),
						A2($author$project$JsonRender$State$get, '/items/1', newModel.state)));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'RemoveState removes from state',
			function (_v4) {
				var model = {
					spec: $elm$core$Maybe$Nothing,
					state: $elm$json$Json$Encode$object(
				...
				var _v5 = A2(
					$author$project$JsonRender$Actions$update,
					$author$project$JsonRender$Actions$RemoveState('/age'),
					model);
				var newModel = _v5.a;
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					A2($author$project$JsonRender$State$get, '/age', newModel.state));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'encodeAction produces correct JSON',
			function (_v6) {
				var json = A2(
					$author$project$JsonRender$Actions$encodeAction,
					'export',
					$elm$json$Json$Encode$object(
						_List_fromArray(
							[
				...
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok('export'),
					name);
			})
		]));
var $author$project$JsonRender$Internal$PropValue$StringValue = function (a) {
	return {$: 'StringValue', a: a};
};
var $author$project$JsonRender$Visibility$Truthy = function (a) {
	return {$: 'Truthy', a: a};
};
...
var $author$project$JsonRender$Actions$CustomAction = F2(
	function (a, b) {
		return {$: 'CustomAction', a: a, b: b};
	});
var $elm$json$Json$Decode$null = _Json_decodeNull;
var $author$project$JsonRender$Visibility$isTruthy = function (value) {
	var _v0 = A2($elm$json$Json$Decode$decodeValue, $elm$json$Json$Decode$bool, value);
	if (_v0.$ === 'Ok') {
		var b = _v0.a;
		return b;
	} else {
		...
		if (_v1.$ === 'Ok') {
			...
			var _v2 = A2($elm$json$Json$Decode$decodeValue, $elm$json$Json$Decode$int, value);
			if (_v2.$ === 'Ok') {
				var n = _v2.a;
				return !(!n);
			} else {
				var _v3 = A2($elm$json$Json$Decode$decodeValue, $elm$json$Json$Decode$float, value);
				if (_v3.$ === 'Ok') {
					var f = _v3.a;
					return f !== 0.0;
				} else {
...
var $author$project$JsonRender$Visibility$propValueMatchesJson = F2(
	function (propVal, jsonVal) {
		switch (propVal.$) {
			case 'StringValue':
				var s = propVal.a;
				return _Utils_eq(
					A2($elm$json$Json$Decode$decodeValue, $elm$json$Json$Decode$string, jsonVal),
					$elm$core$Result$Ok(s));
			case 'IntValue':
				var i = propVal.a;
				return _Utils_eq(
					A2($elm$json$Json$Decode$decodeValue, $elm$json$Json$Decode$int, jsonVal),
					$elm$core$Result$Ok(i));
			case 'FloatValue':
				var f = propVal.a;
				return _Utils_eq(
					A2($elm$json$Json$Decode$decodeValue, $elm$json$Json$Decode$float, jsonVal),
					$elm$core$Result$Ok(f));
			case 'BoolValue':
				var b = propVal.a;
				return _Utils_eq(
					A2($elm$json$Json$Decode$decodeValue, $elm$json$Json$Decode$bool, jsonVal),
					$elm$core$Result$Ok(b));
			case 'NullValue':
				return _Utils_eq(
					A2(
						$elm$json$Json$Decode$decodeValue,
...
var $author$project$JsonRender$Visibility$evaluate = F3(
	function (state, repeatCtx, condition) {
		switch (condition.$) {
			case 'Truthy':
				var path = condition.a;
				var _v1 = A2($author$project$JsonRender$State$get, path, state);
				if (_v1.$ === 'Just') {
					var val = _v1.a;
					return $author$project$JsonRender$Visibility$isTruthy(val);
				} else {
					return false;
				}
			case 'Equals':
				var path = condition.a;
				var expected = condition.b;
				var _v2 = A2($author$project$JsonRender$State$get, path, state);
				if (_v2.$ === 'Just') {
					var val = _v2.a;
					return A2($author$project$JsonRender$Visibility$propValueMatchesJson, expected, val);
				} else {
					return false;
				}
			case 'NotEquals':
				var path = condition.a;
				var expected = condition.b;
				var _v3 = A2($author$project$JsonRender$State$get, path, state);
				if (_v3.$ === 'Just') {
					var val = _v3.a;
					return !A2($author$project$JsonRender$Visibility$propValueMatchesJson, expected, val);
				} else {
			...
			case 'Not':
				var inner = condition.a;
				return !A3($author$project$JsonRender$Visibility$evaluate, state, repeatCtx, inner);
			case 'And':
				var conditions = condition.a;
				return A2(
					$elm$core$List$all,
					A2($author$project$JsonRender$Visibility$evaluate, state, repeatCtx),
					conditions);
			default:
				var conditions = condition.a;
				return A2(
...
var $author$project$JsonRender$Resolve$RBool = function (a) {
	return {$: 'RBool', a: a};
};
var $author$project$JsonRender$Resolve$RFloat = function (a) {
	return {$: 'RFloat', a: a};
};
var $author$project$JsonRender$Resolve$RInt = function (a) {
	return {$: 'RInt', a: a};
};
var $author$project$JsonRender$Resolve$RList = function (a) {
	return {$: 'RList', a: a};
};
var $author$project$JsonRender$Resolve$RNull = {$: 'RNull'};
var $author$project$JsonRender$Resolve$RObject = function (a) {
	return {$: 'RObject', a: a};
};
var $author$project$JsonRender$Resolve$RString = function (a) {
	return {$: 'RString', a: a};
};
var $author$project$JsonRender$Resolve$jsonValueToResolved = function (value) {
	var _v0 = A2($elm$json$Json$Decode$decodeValue, $elm$json$Json$Decode$string, value);
	if (_v0.$ === 'Ok') {
		var s = _v0.a;
		return $author$project$JsonRender$Resolve$RString(s);
	} else {
		var _v1 = A2($elm$json$Json$Decode$decodeValue, $elm$json$Json$Decode$int, value);
		if (_v1.$ === 'Ok') {
			var i = _v1.a;
			return $author$project$JsonRender$Resolve$RInt(i);
		} else {
			var _v2 = A2($elm$json$Json$Decode$decodeValue, $elm$json$Json$Decode$float, value);
			if (_v2.$ === 'Ok') {
				var f = _v2.a;
				return $author$project$JsonRender$Resolve$RFloat(f);
			} else {
				var _v3 = A2($elm$json$Json$Decode$decodeValue, $elm$json$Json$Decode$bool, value);
				if (_v3.$ === 'Ok') {
					var b = _v3.a;
					return $author$project$JsonRender$Resolve$RBool(b);
				} else {
					var _v4 = A2(
						$elm$json$Json$Decode$decodeValue,
						$elm$json$Json$Decode$null(_Utils_Tuple0),
						value);
					if (_v4.$ === 'Ok') {
						return $author$project$JsonRender$Resolve$RNull;
					} else {
						return $author$project$JsonRender$Resolve$RNull;
					}
				}
...
var $author$project$JsonRender$Resolve$jsonValueToString = function (value) {
	var _v0 = A2($elm$json$Json$Decode$decodeValue, $elm$json$Json$Decode$string, value);
	if (_v0.$ === 'Ok') {
		var s = _v0.a;
		return s;
...
var $author$project$JsonRender$Resolve$resolveTemplate = F2(
	function (state, template) {
		var parts = A2($elm$core$String$split, '${', template);
		if (!parts.b) {
			return template;
		} else {
			var first = parts.a;
						...
						function (part) {
							...
							if ((_v1.b && _v1.b.b) && (!_v1.b.b.b)) {
								...
								var resolved = A2(
									...
									A2(
										$elm$core$Maybe$map,
										$author$project$JsonRender$Resolve$jsonValueToString,
										A2($author$project$JsonRender$State$get, path, state)));
								return _Utils_ap(resolved, after);
							} else {
								return '${' + part;
							}
						},
...
var $author$project$JsonRender$Resolve$resolvePropValue = F3(
	function (state, repeatCtx, prop) {
		switch (prop.$) {
			case 'StringValue':
				var s = prop.a;
				return $author$project$JsonRender$Resolve$RString(s);
			...
			case 'ListValue':
				var items = prop.a;
				return $author$project$JsonRender$Resolve$RList(
					A2(
						$elm$core$List$map,
						A2($author$project$JsonRender$Resolve$resolvePropValue, state, repeatCtx),
						items));
			case 'ObjectValue':
				var obj = prop.a;
				return $author$project$JsonRender$Resolve$RObject(
					A2(
						$elm$core$Dict$map,
						F2(
							function (_v1, v) {
								return A3($author$project$JsonRender$Resolve$resolvePropValue, state, repeatCtx, v);
							}),
						obj));
			case 'StateExpr':
				var path = prop.a;
				return $author$project$JsonRender$Resolve$jsonValueToResolved(
					A2(
						$elm$core$Maybe$withDefault,
						$elm$json$Json$Encode$null,
						A2($author$project$JsonRender$State$get, path, state)));
			case 'ItemExpr':
				...
				if (repeatCtx.$ === 'Just') {
					...
					if (_v3.$ === 'Ok') {
						var val = _v3.a;
						return $author$project$JsonRender$Resolve$jsonValueToResolved(val);
					} else {
						return $author$project$JsonRender$Resolve$RNull;
					}
				} else {
			...
			case 'IndexExpr':
				if (repeatCtx.$ === 'Just') {
					var ctx = repeatCtx.a;
					return $author$project$JsonRender$Resolve$RInt(ctx.index);
				} else {
					return $author$project$JsonRender$Resolve$RInt(0);
				}
			default:
				var template = prop.a;
				return $author$project$JsonRender$Resolve$RString(
					A2($author$project$JsonRender$Resolve$resolveTemplate, state, template));
		}
	});
var $author$project$JsonRender$Resolve$resolveProps = F3(
	function (state, repeatCtx, props) {
		return A2(
			$elm$core$Dict$map,
			F2(
				function (_v0, v) {
...
var $author$project$JsonRender$Render$renderElement = F5(
	function (registry, state, repeatCtx, spec, element) {
		var _v1 = element.visible;
		if (_v1.$ === 'Just') {
			var condition = _v1.a;
			return A3($author$project$JsonRender$Visibility$evaluate, state, repeatCtx, condition) ? A5($author$project$JsonRender$Render$renderElementInner, registry, state, repeatCtx, spec, element) : $elm$html$Html$text('');
		} else {
			return A5($author$project$JsonRender$Render$renderElementInner, registry, state, repeatCtx, spec, element);
		}
	});
var $author$project$JsonRender$Render$renderElementInner = F5(
	function (registry, state, repeatCtx, spec, element) {
		var _v0 = A2($elm$core$Dict$get, element.type_, registry);
		if (_v0.$ === 'Just') {
			var componentFn = _v0.a.a;
			var resolved = A3($author$project$JsonRender$Resolve$resolveProps, state, repeatCtx, element.props);
			var children = A2(
				$elm$core$List$filterMap,
				function (id) {
					return A2(
						$elm$core$Maybe$map,
						A4($author$project$JsonRender$Render$renderElement, registry, state, repeatCtx, spec),
						A2($elm$core$Dict$get, id, spec.elements));
				},
				element.children);
			return componentFn(
				{
					children: children,
					emit: function (event) {
						return A2($author$project$JsonRender$Actions$CustomAction, event, $elm$json$Json$Encode$null);
					},
					props: resolved
				});
		} else {
...
var $author$project$JsonRender$Render$render = F3(
	function (registry, state, spec) {
		var _v0 = A2($elm$core$Dict$get, spec.root, spec.elements);
		if (_v0.$ === 'Just') {
			var element = _v0.a;
			return A5($author$project$JsonRender$Render$renderElement, registry, state, $elm$core$Maybe$Nothing, spec, element);
		} else {
			return $elm$html$Html$text('');
		}
	});
...
var $author$project$JsonRender$Render$Component = function (a) {
	return {$: 'Component', a: a};
};
var $author$project$JsonRender$Render$register = F2(
	function (propsDecoder, view) {
		return $author$project$JsonRender$Render$Component(
			function (raw) {
				var _v0 = propsDecoder(raw.props);
				if (_v0.$ === 'Ok') {
					var typed = _v0.a;
					return view(
						{children: raw.children, emit: raw.emit, props: typed});
				} else {
					return $elm$html$Html$text('');
				}
			});
	});
var $author$project$JsonRender$Resolve$required = F4(
	function (key, extract, prev, props) {
		var _v0 = prev(props);
		if (_v0.$ === 'Ok') {
			var f = _v0.a;
			var _v1 = A2($elm$core$Dict$get, key, props);
			if (_v1.$ === 'Just') {
				var val = _v1.a;
				var _v2 = extract(val);
				if (_v2.$ === 'Ok') {
					...
					var err = _v2.a;
					return $elm$core$Result$Err('field \'' + (key + ('\': ' + err)));
				}
			} else {
				return $elm$core$Result$Err('missing required field \'' + (key + '\''));
			}
		} else {
			var err = _v0.a;
			return $elm$core$Result$Err(err);
...
var $author$project$JsonRender$Resolve$string = function (val) {
	if (val.$ === 'RString') {
		var s = val.a;
		return $elm$core$Result$Ok(s);
	} else {
		return $elm$core$Result$Err('expected string');
	}
};
var $author$project$JsonRender$Resolve$succeed = F2(
	function (a, _v0) {
		return $elm$core$Result$Ok(a);
	});
var $author$project$RenderTest$testRegistry = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2(
			'Card',
			A2(
				$author$project$JsonRender$Render$register,
				function (props) {
					return function (d) {
						return d(props);
					}(
						A3(
							$author$project$JsonRender$Resolve$required,
							'title',
							$author$project$JsonRender$Resolve$string,
							$author$project$JsonRender$Resolve$succeed($elm$core$Basics$identity)));
				},
				function (ctx) {
					return A2(
						$elm$html$Html$div,
						...
						_List_fromArray(
							[
								$elm$html$Html$text(ctx.props),
								A2($elm$html$Html$div, _List_Nil, ctx.children)
							]));
				})),
			_Utils_Tuple2(
			'Text',
			A2(
				...
				function (ctx) {
					return $elm$html$Html$text(ctx.props);
				}))
		]));
...
var $author$project$RenderTest$suite = A2(
	$elm_explorations$test$Test$describe,
	'JsonRender.Render',
	_List_fromArray(
		[
			...
			function (_v0) {
				var spec = {
					elements: $elm$core$Dict$fromList(
						_List_fromArray(
							[
								_Utils_Tuple2(
								't',
								{
									children: _List_Nil,
									props: $elm$core$Dict$fromList(
										_List_fromArray(
											[
												_Utils_Tuple2(
												'content',
												$author$project$JsonRender$Internal$PropValue$StringValue('Hello'))
											])),
									type_: 'Text',
				...
				return A2(
					...
					_List_fromArray(
						[
							$elm_explorations$test$Test$Html$Selector$text('Hello')
						]),
					$elm_explorations$test$Test$Html$Query$fromHtml(
						A3($author$project$JsonRender$Render$render, $author$project$RenderTest$testRegistry, $elm$json$Json$Encode$null, spec)));
			}),
			A2(
			$elm_explorations$test$Test$test,
									...
									props: $elm$core$Dict$fromList(
										_List_fromArray(
											[
												_Utils_Tuple2(
												'title',
												$author$project$JsonRender$Internal$PropValue$StringValue('My Card'))
											])),
									type_: 'Card',
									visible: $elm$core$Maybe$Nothing
								}),
									...
									props: $elm$core$Dict$fromList(
										_List_fromArray(
											[
												_Utils_Tuple2(
												'content',
												$author$project$JsonRender$Internal$PropValue$StringValue('Body'))
											])),
									type_: 'Text',
									visible: $elm$core$Maybe$Nothing
								})
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							$elm_explorations$test$Test$Html$Selector$text('My Card'),
							$elm_explorations$test$Test$Html$Selector$text('Body')
						]),
					$elm_explorations$test$Test$Html$Query$fromHtml(
						A3($author$project$JsonRender$Render$render, $author$project$RenderTest$testRegistry, $elm$json$Json$Encode$null, spec)));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'renders nothing for unknown component',
			function (_v2) {
				var spec = {
					elements: $elm$core$Dict$fromList(
						_List_fromArray(
							[
								_Utils_Tuple2(
								't',
								{children: _List_Nil, props: $elm$core$Dict$empty, type_: 'Unknown', visible: $elm$core$Maybe$Nothing})
							])),
					root: 't'
				};
				return A2(
			...
			A2(
			$elm_explorations$test$Test$test,
			'respects visibility condition',
			function (_v3) {
				var state = $elm$json$Json$Encode$object(
					_List_fromArray(
						[
							_Utils_Tuple2(
							'show',
									...
									props: $elm$core$Dict$fromList(
										_List_fromArray(
											[
												_Utils_Tuple2(
												'content',
												$author$project$JsonRender$Internal$PropValue$StringValue('Hidden'))
											])),
									type_: 'Text',
									visible: $elm$core$Maybe$Just(
										$author$project$JsonRender$Visibility$Truthy('/show'))
								})
							])),
					root: 't'
				};
				return A2(
					...
					_List_fromArray(
						[
							$elm_explorations$test$Test$Html$Selector$text('Hidden')
						]),
					$elm_explorations$test$Test$Html$Query$fromHtml(
						A3($author$project$JsonRender$Render$render, $author$project$RenderTest$testRegistry, state, spec)));
			})
		]));
var $author$project$JsonRender$Internal$PropValue$IndexExpr = {$: 'IndexExpr'};
var $author$project$JsonRender$Internal$PropValue$ItemExpr = function (a) {
	return {$: 'ItemExpr', a: a};
};
var $author$project$JsonRender$Internal$PropValue$StateExpr = function (a) {
	return {$: 'StateExpr', a: a};
};
var $author$project$JsonRender$Internal$PropValue$TemplateExpr = function (a) {
	return {$: 'TemplateExpr', a: a};
};
...
var $author$project$JsonRender$Resolve$int = function (val) {
	if (val.$ === 'RInt') {
		var i = val.a;
		return $elm$core$Result$Ok(i);
	} else {
		return $elm$core$Result$Err('expected int');
	}
};
var $author$project$JsonRender$Resolve$optional = F5(
	function (key, extract, _default, prev, props) {
		var _v0 = prev(props);
		if (_v0.$ === 'Ok') {
			var f = _v0.a;
			var _v1 = A2($elm$core$Dict$get, key, props);
...
var $author$project$ResolveTest$suite = A2(
	$elm_explorations$test$Test$describe,
	'JsonRender.Resolve',
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					...
					function (_v0) {
						...
						var resolved = A3($author$project$JsonRender$Resolve$resolveProps, $author$project$ResolveTest$state, $elm$core$Maybe$Nothing, props);
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Maybe$Just(
								$author$project$JsonRender$Resolve$RString('Hello')),
							A2($elm$core$Dict$get, 'title', resolved));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'resolves $state expression',
					function (_v1) {
						var props = $elm$core$Dict$fromList(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'name',
									$author$project$JsonRender$Internal$PropValue$StateExpr('/user/name'))
								]));
						var resolved = A3($author$project$JsonRender$Resolve$resolveProps, $author$project$ResolveTest$state, $elm$core$Maybe$Nothing, props);
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Maybe$Just(
								$author$project$JsonRender$Resolve$RString('Alice')),
							A2($elm$core$Dict$get, 'name', resolved));
					}),
					A2(
					$elm_explorations$test$Test$test,
						...
						var props = $elm$core$Dict$fromList(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'msg',
									$author$project$JsonRender$Internal$PropValue$TemplateExpr('Hi ${/user/name}!'))
								]));
						var resolved = A3($author$project$JsonRender$Resolve$resolveProps, $author$project$ResolveTest$state, $elm$core$Maybe$Nothing, props);
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Maybe$Just(
								$author$project$JsonRender$Resolve$RString('Hi Alice!')),
							A2($elm$core$Dict$get, 'msg', resolved));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'resolves $item expression',
					function (_v3) {
						var props = $elm$core$Dict$fromList(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'itemId',
									$author$project$JsonRender$Internal$PropValue$ItemExpr('id'))
								]));
						var item = $elm$json$Json$Encode$object(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'id',
									$elm$json$Json$Encode$string('abc'))
								]));
						var ctx = $elm$core$Maybe$Just(
							{index: 2, item: item});
						var resolved = A3($author$project$JsonRender$Resolve$resolveProps, $author$project$ResolveTest$state, ctx, props);
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Maybe$Just(
								$author$project$JsonRender$Resolve$RString('abc')),
							A2($elm$core$Dict$get, 'itemId', resolved));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v4) {
						var props = $elm$core$Dict$fromList(
							_List_fromArray(
								[
									_Utils_Tuple2('idx', $author$project$JsonRender$Internal$PropValue$IndexExpr)
								]));
						var ctx = $elm$core$Maybe$Just(
							{index: 5, item: $elm$json$Json$Encode$null});
						var resolved = A3($author$project$JsonRender$Resolve$resolveProps, $author$project$ResolveTest$state, ctx, props);
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Maybe$Just(
								$author$project$JsonRender$Resolve$RInt(5)),
							A2($elm$core$Dict$get, 'idx', resolved));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'succeed + required decodes props',
					function (_v5) {
						var props = $elm$core$Dict$fromList(
							_List_fromArray(
								[
						...
						var result = function (d) {
							...
							A3(
								$author$project$JsonRender$Resolve$required,
								'count',
								$author$project$JsonRender$Resolve$int,
								A3(
									$author$project$JsonRender$Resolve$required,
									'title',
									$author$project$JsonRender$Resolve$string,
									$author$project$JsonRender$Resolve$succeed($elm$core$Tuple$pair))));
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Result$Ok(
								_Utils_Tuple2('Hello', 5)),
							result);
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v6) {
						var props = $elm$core$Dict$fromList(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'title',
									$author$project$JsonRender$Resolve$RString('Hi'))
								]));
						var result = function (d) {
							return d(props);
						}(
							A4(
								$author$project$JsonRender$Resolve$optional,
								'subtitle',
								$author$project$JsonRender$Resolve$string,
								$elm$core$Maybe$Nothing,
								A3(
						...
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Result$Ok(
								_Utils_Tuple2('Hi', $elm$core$Maybe$Nothing)),
							result);
					}),
					A2(
					$elm_explorations$test$Test$test,
					'required fails on missing field',
					function (_v7) {
						var props = $elm$core$Dict$empty;
						var result = function (d) {
							return d(props);
						}(
							A3(
								...
								$author$project$JsonRender$Resolve$string,
								$author$project$JsonRender$Resolve$succeed($elm$core$Basics$identity)));
						return $elm_explorations$test$Expect$err(result);
					})
				]))
		]));
var $author$project$JsonRender$Internal$PropValue$BoolValue = function (a) {
	return {$: 'BoolValue', a: a};
};
var $author$project$JsonRender$Internal$PropValue$FloatValue = function (a) {
	return {$: 'FloatValue', a: a};
};
var $author$project$JsonRender$Internal$PropValue$IntValue = function (a) {
	return {$: 'IntValue', a: a};
};
...
var $author$project$JsonRender$Spec$Spec = F2(
	function (root, elements) {
		return {elements: elements, root: root};
	});
var $author$project$JsonRender$Spec$Element = F4(
	function (type_, props, children, visible) {
		return {children: children, props: props, type_: type_, visible: visible};
	});
var $author$project$JsonRender$Internal$PropValue$ListValue = function (a) {
	return {$: 'ListValue', a: a};
};
var $author$project$JsonRender$Internal$PropValue$NullValue = {$: 'NullValue'};
var $author$project$JsonRender$Internal$PropValue$ObjectValue = function (a) {
...
function $author$project$JsonRender$Internal$PropValue$cyclic$decoder() {
	return $elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
				A2(
				$elm$json$Json$Decode$map,
				$author$project$JsonRender$Internal$PropValue$StateExpr,
				A2($elm$json$Json$Decode$field, '$state', $elm$json$Json$Decode$string)),
				A2(
				$elm$json$Json$Decode$map,
				$author$project$JsonRender$Internal$PropValue$ItemExpr,
				A2($elm$json$Json$Decode$field, '$item', $elm$json$Json$Decode$string)),
				A2(
				$elm$json$Json$Decode$field,
				'$index',
				$elm$json$Json$Decode$succeed($author$project$JsonRender$Internal$PropValue$IndexExpr)),
				A2(
				$elm$json$Json$Decode$map,
				$author$project$JsonRender$Internal$PropValue$TemplateExpr,
				A2($elm$json$Json$Decode$field, '$template', $elm$json$Json$Decode$string)),
				$elm$json$Json$Decode$null($author$project$JsonRender$Internal$PropValue$NullValue),
				A2($elm$json$Json$Decode$map, $author$project$JsonRender$Internal$PropValue$BoolValue, $elm$json$Json$Decode$bool),
				A2($elm$json$Json$Decode$map, $author$project$JsonRender$Internal$PropValue$IntValue, $elm$json$Json$Decode$int),
				A2($elm$json$Json$Decode$map, $author$project$JsonRender$Internal$PropValue$FloatValue, $elm$json$Json$Decode$float),
				A2($elm$json$Json$Decode$map, $author$project$JsonRender$Internal$PropValue$StringValue, $elm$json$Json$Decode$string),
				A2(
				$elm$json$Json$Decode$map,
				$author$project$JsonRender$Internal$PropValue$ListValue,
				$elm$json$Json$Decode$lazy(
					function (_v0) {
						return $elm$json$Json$Decode$list(
							$author$project$JsonRender$Internal$PropValue$cyclic$decoder());
					})),
				A2(
				$elm$json$Json$Decode$map,
				$author$project$JsonRender$Internal$PropValue$ObjectValue,
				$elm$json$Json$Decode$lazy(
					function (_v1) {
...
try {
	var $author$project$JsonRender$Internal$PropValue$decoder = $author$project$JsonRender$Internal$PropValue$cyclic$decoder();
	$author$project$JsonRender$Internal$PropValue$cyclic$decoder = function () {
		return $author$project$JsonRender$Internal$PropValue$decoder;
	};
} catch ($) {
	throw 'Some top-level definitions from `JsonRender.Internal.PropValue` are causing infinite recursion:\n\n  ┌─────┐\n  │    decoder\n  └─────┘\n\nThese errors are very tricky, so read https://elm-lang.org/0.19.1/bad-recursion to learn how to fix it!';}
var $author$project$JsonRender$Visibility$And = function (a) {
	return {$: 'And', a: a};
};
var $author$project$JsonRender$Visibility$Equals = F2(
	function (a, b) {
		return {$: 'Equals', a: a, b: b};
	});
var $author$project$JsonRender$Visibility$Not = function (a) {
	return {$: 'Not', a: a};
};
var $author$project$JsonRender$Visibility$NotEquals = F2(
	function (a, b) {
		return {$: 'NotEquals', a: a, b: b};
	});
var $author$project$JsonRender$Visibility$Or = function (a) {
	return {$: 'Or', a: a};
};
...
function $author$project$JsonRender$Visibility$cyclic$decoder() {
	return $elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
				A2(
				...
				A3(
					...
					'value',
					$author$project$JsonRender$Internal$PropValue$decoder,
					A3(
						$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
						'path',
						$elm$json$Json$Decode$string,
						$elm$json$Json$Decode$succeed($author$project$JsonRender$Visibility$Equals)))),
				A2(
				$elm$json$Json$Decode$field,
				'notEquals',
				A3(
					...
					A3(
						...
						'path',
						$elm$json$Json$Decode$string,
						$elm$json$Json$Decode$succeed($author$project$JsonRender$Visibility$NotEquals)))),
				A2(
				$elm$json$Json$Decode$field,
				'truthy',
				A2($elm$json$Json$Decode$map, $author$project$JsonRender$Visibility$Truthy, $elm$json$Json$Decode$string)),
				A2(
				$elm$json$Json$Decode$field,
				'not',
				A2(
					$elm$json$Json$Decode$map,
					$author$project$JsonRender$Visibility$Not,
					$elm$json$Json$Decode$lazy(
						function (_v0) {
							return $author$project$JsonRender$Visibility$cyclic$decoder();
						}))),
				A2(
				$elm$json$Json$Decode$field,
				'and',
				A2(
					$elm$json$Json$Decode$map,
					$author$project$JsonRender$Visibility$And,
					$elm$json$Json$Decode$lazy(
						function (_v1) {
							return $elm$json$Json$Decode$list(
								$author$project$JsonRender$Visibility$cyclic$decoder());
						}))),
				A2(
				$elm$json$Json$Decode$field,
				'or',
				A2(
					$elm$json$Json$Decode$map,
					$author$project$JsonRender$Visibility$Or,
					$elm$json$Json$Decode$lazy(
						function (_v2) {
							return $elm$json$Json$Decode$list(
								$author$project$JsonRender$Visibility$cyclic$decoder());
...
try {
	var $author$project$JsonRender$Visibility$decoder = $author$project$JsonRender$Visibility$cyclic$decoder();
	$author$project$JsonRender$Visibility$cyclic$decoder = function () {
		return $author$project$JsonRender$Visibility$decoder;
	};
} catch ($) {
	throw 'Some top-level definitions from `JsonRender.Visibility` are causing infinite recursion:\n\n  ┌─────┐\n  │    decoder\n  └─────┘\n\nThese errors are very tricky, so read https://elm-lang.org/0.19.1/bad-recursion to learn how to fix it!';}
...
var $author$project$JsonRender$Spec$elementDecoder = A4(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
	'visible',
	A2($elm$json$Json$Decode$map, $elm$core$Maybe$Just, $author$project$JsonRender$Visibility$decoder),
	$elm$core$Maybe$Nothing,
	A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'children',
		...
		A3(
			$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
			'props',
			$elm$json$Json$Decode$dict($author$project$JsonRender$Internal$PropValue$decoder),
			A3(
				$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
				'type',
				$elm$json$Json$Decode$string,
				$elm$json$Json$Decode$succeed($author$project$JsonRender$Spec$Element)))));
var $author$project$JsonRender$Spec$decoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'elements',
	$elm$json$Json$Decode$dict($author$project$JsonRender$Spec$elementDecoder),
	A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'root',
		$elm$json$Json$Decode$string,
		$elm$json$Json$Decode$succeed($author$project$JsonRender$Spec$Spec)));
...
var $author$project$SpecTest$suite = A2(
	$elm_explorations$test$Test$describe,
	'JsonRender.Spec',
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$test,
			'decodes a basic spec',
			function (_v0) {
				var _v1 = A2($elm$json$Json$Decode$decodeString, $author$project$JsonRender$Spec$decoder, $author$project$SpecTest$specJson);
				if (_v1.$ === 'Ok') {
					var spec = _v1.a;
					return A2(
						...
						_List_fromArray(
							[
								function (s) {
								return A2($elm_explorations$test$Expect$equal, 'card-1', s.root);
							},
								function (s) {
								return A2(
									$elm_explorations$test$Expect$equal,
									2,
									$elm$core$Dict$size(s.elements));
							}
							]),
						spec);
				} else {
			...
			A2(
			$elm_explorations$test$Test$test,
			'decodes element props as PropValues',
			function (_v2) {
				var _v3 = A2($elm$json$Json$Decode$decodeString, $author$project$JsonRender$Spec$decoder, $author$project$SpecTest$specJson);
				if (_v3.$ === 'Ok') {
					var spec = _v3.a;
					var _v4 = A2($elm$core$Dict$get, 'card-1', spec.elements);
					if (_v4.$ === 'Just') {
						var el = _v4.a;
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Maybe$Just(
								$author$project$JsonRender$Internal$PropValue$StringValue('Hello')),
							A2($elm$core$Dict$get, 'title', el.props));
					} else {
						return $elm_explorations$test$Expect$fail('element card-1 not found');
					}
				} else {
					var err = _v3.a;
					return $elm_explorations$test$Expect$fail(
			...
			A2(
			$elm_explorations$test$Test$test,
			'decodes $state expression',
			function (_v5) {
				var json = '\n                        {\n                          "root": "t",\n                          "elements": {\n                            "t": {\n                              "type": "Text",\n                              "props": { "value": { "$state": "/user/name" } },\n                              "children": []\n                            }\n                          }\n                        }\n                        ';
				var _v6 = A2($elm$json$Json$Decode$decodeString, $author$project$JsonRender$Spec$decoder, json);
				if (_v6.$ === 'Ok') {
					var spec = _v6.a;
					var _v7 = A2($elm$core$Dict$get, 't', spec.elements);
					if (_v7.$ === 'Just') {
						var el = _v7.a;
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Maybe$Just(
								$author$project$JsonRender$Internal$PropValue$StateExpr('/user/name')),
							A2($elm$core$Dict$get, 'value', el.props));
					} else {
						return $elm_explorations$test$Expect$fail('element not found');
					}
				} else {
					var err = _v6.a;
					return $elm_explorations$test$Expect$fail(
			...
			A2(
			$elm_explorations$test$Test$test,
			'decodes $template expression',
			function (_v8) {
				var json = '\n                        {\n                          "root": "t",\n                          "elements": {\n                            "t": {\n                              "type": "Text",\n                              "props": { "greeting": { "$template": "Hello ${/name}" } },\n                              "children": []\n                            }\n                          }\n                        }\n                        ';
				var _v9 = A2($elm$json$Json$Decode$decodeString, $author$project$JsonRender$Spec$decoder, json);
				if (_v9.$ === 'Ok') {
					var spec = _v9.a;
					var _v10 = A2($elm$core$Dict$get, 't', spec.elements);
					if (_v10.$ === 'Just') {
						var el = _v10.a;
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Maybe$Just(
								$author$project$JsonRender$Internal$PropValue$TemplateExpr('Hello ${/name}')),
							A2($elm$core$Dict$get, 'greeting', el.props));
					} else {
						return $elm_explorations$test$Expect$fail('element not found');
					}
				} else {
			...
			A2(
			$elm_explorations$test$Test$test,
			'decodes $item expression',
			function (_v11) {
				var json = '\n                        {\n                          "root": "t",\n                          "elements": {\n                            "t": {\n                              "type": "Text",\n                              "props": { "name": { "$item": "name" } },\n                              "children": []\n                            }\n                          }\n                        }\n                        ';
				var _v12 = A2($elm$json$Json$Decode$decodeString, $author$project$JsonRender$Spec$decoder, json);
				if (_v12.$ === 'Ok') {
					var spec = _v12.a;
					var _v13 = A2($elm$core$Dict$get, 't', spec.elements);
					if (_v13.$ === 'Just') {
						var el = _v13.a;
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Maybe$Just(
								$author$project$JsonRender$Internal$PropValue$ItemExpr('name')),
							A2($elm$core$Dict$get, 'name', el.props));
					} else {
						return $elm_explorations$test$Expect$fail('element not found');
					}
				} else {
			...
			A2(
			$elm_explorations$test$Test$test,
			'decodes $index expression',
			function (_v14) {
				var json = '\n                        {\n                          "root": "t",\n                          "elements": {\n                            "t": {\n                              "type": "Text",\n                              "props": { "idx": { "$index": true } },\n                              "children": []\n                            }\n                          }\n                        }\n                        ';
				var _v15 = A2($elm$json$Json$Decode$decodeString, $author$project$JsonRender$Spec$decoder, json);
				if (_v15.$ === 'Ok') {
					var spec = _v15.a;
					var _v16 = A2($elm$core$Dict$get, 't', spec.elements);
					if (_v16.$ === 'Just') {
						var el = _v16.a;
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Maybe$Just($author$project$JsonRender$Internal$PropValue$IndexExpr),
							A2($elm$core$Dict$get, 'idx', el.props));
					} else {
						return $elm_explorations$test$Expect$fail('element not found');
					}
				} else {
			...
			A2(
			$elm_explorations$test$Test$test,
			'decodes numeric prop values',
			function (_v17) {
				var json = '\n                        {\n                          "root": "t",\n                          "elements": {\n                            "t": {\n                              "type": "Metric",\n                              "props": { "value": 42, "ratio": 3.14, "active": true },\n                              "children": []\n                            }\n                          }\n                        }\n                        ';
				var _v18 = A2($elm$json$Json$Decode$decodeString, $author$project$JsonRender$Spec$decoder, json);
				if (_v18.$ === 'Ok') {
					var spec = _v18.a;
					var _v19 = A2($elm$core$Dict$get, 't', spec.elements);
					if (_v19.$ === 'Just') {
						var el = _v19.a;
						return A2(
							$elm_explorations$test$Expect$all,
							_List_fromArray(
								[
									...
									return A2(
										$elm_explorations$test$Expect$equal,
										$elm$core$Maybe$Just(
											$author$project$JsonRender$Internal$PropValue$IntValue(42)),
										A2($elm$core$Dict$get, 'value', e.props));
								},
									function (e) {
									return A2(
										$elm_explorations$test$Expect$equal,
										$elm$core$Maybe$Just(
											$author$project$JsonRender$Internal$PropValue$FloatValue(3.14)),
										A2($elm$core$Dict$get, 'ratio', e.props));
								},
									function (e) {
									return A2(
										$elm_explorations$test$Expect$equal,
										$elm$core$Maybe$Just(
											$author$project$JsonRender$Internal$PropValue$BoolValue(true)),
										A2($elm$core$Dict$get, 'active', e.props));
								}
								]),
							el);
					} else {
...
var $author$project$StateTest$suite = A2(
	$elm_explorations$test$Test$describe,
	'JsonRender.State',
	_List_fromArray(
		[
				...
				[
						...
						return A2(
							...
							A2(
								...
								A2(
									...
									$elm$json$Json$Decode$decodeValue($elm$json$Json$Decode$string),
									$elm$core$Result$toMaybe),
								A2($author$project$JsonRender$State$get, '/name', state)));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'gets a nested key',
						...
						return A2(
							...
							A2(
								...
								A2(
									...
									$elm$json$Json$Decode$decodeValue($elm$json$Json$Decode$string),
									$elm$core$Result$toMaybe),
								A2($author$project$JsonRender$State$get, '/user/name', state)));
					}),
					A2(
					$elm_explorations$test$Test$test,
						...
						return A2(
							...
							A2(
								...
								A2(
									...
									$elm$json$Json$Decode$decodeValue($elm$json$Json$Decode$string),
									$elm$core$Result$toMaybe),
								A2($author$project$JsonRender$State$get, '/items/1', state)));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v3) {
						...
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Maybe$Nothing,
							A2($author$project$JsonRender$State$get, '/age', state));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'returns root for empty path',
					function (_v4) {
						var state = $elm$json$Json$Encode$string('hello');
						return A2(
							$elm_explorations$test$Expect$equal,
							...
							A2(
								...
								A2(
									...
									$elm$json$Json$Decode$decodeValue($elm$json$Json$Decode$string),
									$elm$core$Result$toMaybe),
								A2($author$project$JsonRender$State$get, '', state)));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
						...
						return A2(
							...
							A2(
								...
								A2(
									...
									$elm$json$Json$Decode$decodeValue($elm$json$Json$Decode$string),
									$elm$core$Result$toMaybe),
								A2($author$project$JsonRender$State$get, '/name', result)));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'sets a nested key',
						...
						return A2(
							...
							A2(
								...
								A2(
									...
									$elm$json$Json$Decode$decodeValue($elm$json$Json$Decode$string),
									$elm$core$Result$toMaybe),
								A2($author$project$JsonRender$State$get, '/user/name', result)));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
			...
			_List_fromArray(
				[
					...
					function (_v7) {
						...
						var result = A3(
							$author$project$JsonRender$State$push,
							'/items',
						...
						return A2(
							...
							A2(
								...
								A2(
									...
									$elm$json$Json$Decode$decodeValue($elm$json$Json$Decode$string),
									$elm$core$Result$toMaybe),
								A2($author$project$JsonRender$State$get, '/items/2', result)));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
			...
			_List_fromArray(
				[
					...
					function (_v8) {
						...
						var result = A2($author$project$JsonRender$State$remove, '/age', state);
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Maybe$Nothing,
							A2($author$project$JsonRender$State$get, '/age', result));
					})
				]))
		]));
var $author$project$VisibilityTest$suite = A2(
	$elm_explorations$test$Test$describe,
	'JsonRender.Visibility',
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$test,
			'Truthy returns true for truthy value',
			function (_v0) {
				return A2(
					$elm_explorations$test$Expect$equal,
					true,
					A3(
						$author$project$JsonRender$Visibility$evaluate,
						$author$project$VisibilityTest$state,
						$elm$core$Maybe$Nothing,
						$author$project$JsonRender$Visibility$Truthy('/isAdmin')));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'Truthy returns false for falsy value',
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					false,
					A3(
						...
						$author$project$VisibilityTest$state,
						$elm$core$Maybe$Nothing,
						$author$project$JsonRender$Visibility$Truthy('/count')));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v2) {
				return A2(
					...
					A3(
						...
						$elm$core$Maybe$Nothing,
						A2(
							$author$project$JsonRender$Visibility$Equals,
							'/role',
							$author$project$JsonRender$Internal$PropValue$StringValue('admin'))));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'NotEquals works',
			function (_v3) {
				return A2(
					...
					A3(
						...
						$elm$core$Maybe$Nothing,
						A2(
							$author$project$JsonRender$Visibility$NotEquals,
							'/role',
							$author$project$JsonRender$Internal$PropValue$StringValue('user'))));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'Not inverts',
...
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['/Users/dokkora/work/json-render-elm/packages/elm-core/tests/ActionsTest.elm', '/Users/dokkora/work/json-render-elm/packages/elm-core/tests/RenderTest.elm', '/Users/dokkora/work/json-render-elm/packages/elm-core/tests/ResolveTest.elm', '/Users/dokkora/work/json-render-elm/packages/elm-core/tests/SpecTest.elm', '/Users/dokkora/work/json-render-elm/packages/elm-core/tests/StateTest.elm', '/Users/dokkora/work/json-render-elm/packages/elm-core/tests/VisibilityTest.elm']),
		processes: 10,
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$ActionsTest$suite)
				])),
			_Utils_Tuple2(
			'RenderTest',
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$RenderTest$testRegistry),
					$author$project$Test$Runner$Node$check($author$project$RenderTest$suite)
				])),
			_Utils_Tuple2(
			'ResolveTest',
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$ResolveTest$state),
					$author$project$Test$Runner$Node$check($author$project$ResolveTest$suite)
				])),
			_Utils_Tuple2(
			'SpecTest',
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$SpecTest$specJson),
					$author$project$Test$Runner$Node$check($author$project$SpecTest$suite)
				])),
			_Utils_Tuple2(
			'StateTest',
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$StateTest$suite)
				])),
			_Utils_Tuple2(
			'VisibilityTest',
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$VisibilityTest$state),
					$author$project$Test$Runner$Node$check($author$project$VisibilityTest$suite)
				]))
		]));
_Platform_export({'Test':{'Generated':{'Main':{'init':$author$project$Test$Generated$Main$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-13078.sock";
var net = require('net'),
