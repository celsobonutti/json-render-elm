...
sampleSchemaJson =
    """{"components":{"Card":{"props":{"type":"object","properties":{"title":{"type":"string"}},"required":["title"]},"description":"A card","slots":["default"],"bindable":[],"validatable":[]}},"actions":{"press":{"params":{"type":"object","properties":{},"required":[]},"description":"Generic button press"}}}"""
...
"""
        ...
        , test "reports incomplete registry" <|
            \_ ->
                let
                    twoComponentSchema =
                        """{"components":{"Card":{"props":{"type":"object","properties":{"title":{"type":"string"}},"required":["title"]},"description":"A card","slots":["default"],"bindable":[],"validatable":[]},"Button":{"props":{"type":"object","properties":{"label":{"type":"string"}},"required":["label"]},"description":"A button","slots":[],"bindable":[],"validatable":[]}}}"""
            ...
            \_ ->
                let
                    schemaWithTwoActions =
                        """{"components":{"Card":{"props":{"type":"object","properties":{"title":{"type":"string"}},"required":["title"]},"description":"A card","slots":["default"],"bindable":[],"validatable":[]}},"actions":{"press":{"params":{"type":"object","properties":{},"required":[]},"description":"Generic button press"},"export":{"params":{"type":"object","properties":{"format":{"type":"string"}},"required":["format"]},"description":"Export data"}}}"""
...
"""
        ...
        , test "no actions in catalog means no actions module needed" <|
            \_ ->
                let
                    noActionsSchema =
                        """{"components":{"Card":{"props":{"type":"object","properties":{"title":{"type":"string"}},"required":["title"]},"description":"A card","slots":["default"],"bindable":[],"validatable":[]}}}"""
...
"""
        ...
        , test "no error when component uses registerStateful instead of register" <|
            \_ ->
                [ """{- This module was generated by the CatalogSync elm-review rule.
   These values were created by the rule, and will be overwritten by it if changed:
   - type alias CardProps
...
component : Component msg
component =
    registerStateful propsDecoder (\\_ -> ()) (\\_ -> ()) (\\_ -> { init = (), update = \\_ m -> m }) view
